...
:mod:`patcher_api.data`. The ``client`` fixture overrides FastAPI's
:func:`patcher_api.db.get_session` dependency to use the per-test session,
keeping production state (the real SQLite file) untouched.
"""
